...
KNOWN_PERFORMERS = [
    ...
    "Ashlee", "Ashley", "Ashley Hinshaw", "Ashley Judd", "Asia Argento", "Asa Akira",
    "Audrey Bitoni", "August Ames", "Autumn Falls", "Ava Addams", "Backroom Casting Couch",
    "Bella", "Billie Star", "Blake Blossom", "Bobbi Starr", "Boxxy", "Brandie Love",
    ...
    "Capri Anderson", "Capri Cavanni", "Caprice", "Carla Gugino", "Carlie",
    "Carmella Bing", "Carmen Luvana", "Cassie Young", "Cassidy Banks", "Cathy Heaven",
    "Celeste Star", "Charlize Theron", "Charlotte Gainsbourg", "Chloe Sevigny",
    "Christina Koletsa", "Christina Ricci", "Claudine Digard", "Coco Lovelock",
    "Cory Chase", "Courteney Cox", "Courtney Cummz", "Crystal Jane", "Dana Delany",
    "Dana Dearmond", "Debra Cole", "Demi Moore", "Devon", "Diana Doll", "Diane Farr",
    "Diane Kruger", "Diane Lane", "Dillion Harper", "Elena Grimaldi", "Elisha Cuthbert",
    "Eliza Dushku", "Ellie Eilish", "Elsa Jean", "Emily Browning", "Emily Willis",
    "Emma Starr", "Emmanuelle Beart", "Emmanuelle Vaugier", "Esperanza Gomez",
    "Eva Green", "Eva Lovia", "Eva Mendes", "Gabbie Carter", "Gia Paige",
    "Gianna Michaels", "Gracie Glam", "Gretchen Mol", "Halle Berry", "Heather Graham",
    "Heather Vandeven", "Helen Mirren", "Honey Gold", "India Summer", "Ivana Milicevic",
    ...
    "Jessica Alba", "Jessica Biel", "Jordi El Nino Polla", "Juelz Ventura",
    "Julia Alexandratou", "Julia Ann", "Julianna Guill", "Jules Jordan", "Julie Benz",
    "Kagney Linn Karter", "Katerina Stikoudi", "Kate Hudson", "Kate Winslet", "Katsuni",
    ...
    "Lena Headey", "Lena Paul", "Lexi Belle", "Lexi Love", "Lexie Fux", "Linda Lovelace",
    "Lindsay Lohan", "Lisa Ann", "Little Caprice", "Liv Tyler", "Liya Silver",
    "Lizzy Caplan", "Lolly Badcock", "Ludivine Sagnier", "Luna Okko", "Maitland Ward",
    "Malena Morgan", "Malin Akerman", "Maria Bello", "Marion Cotillard", "Marisa Tomei",
    ...
    "Michelle Trachtenberg", "Mila Kunis", "Milla Jovovich", "Miss Alice 18",
    "Monica Bellucci", "Monica Sweetheart", "Naomi Swann", "Naomi Watts",
    ...
    "Olivia Wilde", "Pamela Anderson", "Penelope Cruz", "Penny Pax", "Peta Jensen",
    "Phoebe Cates", "Phoenix Marie", "Priya Rai", "Quinn Wilde", "Rachel Miner",
    "Rachel Roxxx", "Rachel Weisz", "Reese Witherspoon", "Remy LaCroix", "Rhona Mitra",
    "Riley Reid", "Riley Steele", "Rinko Kikuchi", "Rocco Reed", "Rose McGowan",
    "Salma Hayek", "Sarah Michelle Gellar", "Sasha Grey", "Savannah Sixx",
    "Scarlit Scandal", "Scarlett Johansson", "Shannon Elizabeth", "Sharon Stone",
    ...
    "Talia Mint", "Tanna Marie", "Tara Reid", "Taylor Wane", "Teagan Presley",
    "Teanna Trump", "Tina Fire", "Tori Black", "Uma Thurman", "Vana Barba",
    "Veronica Da Souza", "Veronica Vanoza", "Veronica Wasko", "Veronika Zemanova",
    "Vicki Chase", "Vina Sky", "Virginie Ledoyen", "Winona Ryder"
]
