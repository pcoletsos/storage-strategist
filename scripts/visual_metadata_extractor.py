...
KNOWN_PERFORMERS = [
    ...
    "Amy", "Amy Adams", "Amy Brooke", "Angela White", "Angelina", "Angelina Jolie",
    "Anna Chlumsky", "Anne Hathaway", "AnnMarie Rios", "Apolonia Lapiedra", "April O'Neil",
    "Ariana Marie", "Ariella Ferrera", "Ashlee", "Ashley", "Ashley Hinshaw", "Ashley Judd",
    "Asia Argento", "Asa Akira", "Audrey Bitoni", "August Ames", "Autumn Falls",
    "Ava Addams", "Backroom Casting Couch", "Bella", "Billie Star", "Blake Blossom",
    "Bobbi Starr", "Boxxy", "Brandie Love", "Brandi Love", "Breanne Benson",
    "Briana Blair", "Brianna", "Brittany", "Cameron Diaz", "Capri Anderson",
    "Capri Cavanni", "Caprice", "Carla Gugino", "Carlie", "Carmella Bing",
    "Cassidy Banks", "Cathy Heaven", "Celeste Star", "Charlize Theron",
    "Charlotte Gainsbourg", "Chloe Sevigny", "Christina Koletsa", "Christina Ricci",
    "Claudine Digard", "Coco Lovelock", "Cory Chase", "Courteney Cox", "Courtney Cummz",
    "Crystal Jane", "Dana Delany", "Dana Dearmond", "Debra Cole", "Demi Moore",
    "Diana Doll", "Diane Farr", "Diane Kruger", "Diane Lane", "Dillion Harper",
    "Elisha Cuthbert", "Eliza Dushku", "Ellie Eilish", "Elsa Jean", "Emily Browning",
    "Emily Willis", "Emma Starr", "Emmanuelle Beart", "Emmanuelle Vaugier",
    "Esperanza Gomez", "Eva Green", "Eva Lovia", "Eva Mendes", "Gabbie Carter",
    "Gia Paige", "Gianna Michaels", "Gracie Glam", "Gretchen Mol", "Halle Berry",
    "Heather Graham", "Helen Mirren", "Honey Gold", "India Summer", "Ivana Milicevic",
    "Izabella Carr", "Izzy Green", "Jaime Pressly", "Jamie Lee Curtis", "Jana Kaderabkova",
    "Janice Griffith", "January Jones", "Jayden Jaymes", "Jenna Jameson", "Jennifer Connelly",
    "Jennifer Tilly", "Jesse Jane", "Jessica Alba", "Jessica Biel", "Jordi El Nino Polla",
    "Juelz Ventura", "Julia Alexandratou", "Julia Ann", "Julianna Guill", "Jules Jordan",
    "Julie Benz", "Kagney Linn Karter", "Katerina Stikoudi", "Kate Hudson", "Kate Winslet",
    "Katie Holmes", "Kayden Kross", "Kelly Preston", "Kenna James", "Kendra Lust",
    "Kenzie Madison", "Kim Basinger", "Kim Cattrall", "Kimmy Granger", "Kirsten Dunst",
    "Kortney Kane", "Kristen Bell", "Kristen Stewart", "Krissy Lynn", "Kyler Quinn",
    "Lana Rhoades", "Laura Prepon", "Lela Star", "Lena Headey", "Lena Paul",
    "Lexi Belle", "Lexi Love", "Lexie Fux", "Lindsay Lohan", "Lisa Ann", "Little Caprice",
    "Liv Tyler", "Liya Silver", "Lizzy Caplan", "Ludivine Sagnier", "Maitland Ward",
    ...
    "Mia Melano", "Michelle Pfeiffer", "Michelle Trachtenberg", "Mila Kunis", "Milla Jovovich",
    "Monica Bellucci", "Naomi Swann", "Naomi Watts", "Natasha Henstridge", "Natalie Portman",
    "Nia Nacci", "Nicole Aniston", "Nicole Kidman", "Nikki Benz", "Nikoleta Ralli",
    "Olga Farmaki", "Olivia Wilde", "Pamela Anderson", "Penelope Cruz", "Penny Pax",
    "Peta Jensen", "Phoebe Cates", "Phoenix Marie", "Priya Rai", "Quinn Wilde",
    "Rachel Miner", "Rachel Roxxx", "Rachel Weisz", "Reese Witherspoon", "Remy LaCroix",
    "Rhona Mitra", "Riley Reid", "Riley Steele", "Rinko Kikuchi", "Rocco Reed",
    "Rose McGowan", "Salma Hayek", "Sarah Michelle Gellar", "Sasha Grey", "Savannah Sixx",
    "Scarlit Scandal", "Scarlett Johansson", "Shannon Elizabeth", "Sharon Stone",
    "Sherilyn Fenn", "Shyla Stylez", "Sienna Miller", "Sophie Marceau", "Stacy Cruz",
    "Stephanie Niznik", "Stoya", "Sunny Leone", "Susan Sarandon", "Talia Mint",
    "Tanna Marie", "Tara Reid", "Taylor Wane", "Teagan Presley", "Teanna Trump",
    "Tina Fire", "Tori Black", "Uma Thurman", "Vana Barba", "Veronica Wasko",
